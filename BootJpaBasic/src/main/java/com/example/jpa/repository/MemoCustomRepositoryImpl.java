...
public class MemoCustomRepositoryImpl implements MemoCustomRepository {
    ...
    public MemoCustomRepositoryImpl(EntityManager entityManager) {
        this.jpaQueryFactory = new JPAQueryFactory(entityManager); //직접생성-객체가 생성되는 순서때문에
    }
    ...
    public Memo selectDsl() {
        ...
        //jpaQueryFactory로 sql를 작성
        //select * from memo where mno =10 where order by text desc
