...
public class JPARestController {
    ...
    //클라이언트에서 값을 보낼때는 경로?page=1&amount=10
    ...
    public ResponseEntity<PageDTO<Memo>> getFindAll(Criteria cri){
        ...
        if(cri.getSearchType() != null && cri.getSearchType().equals("textWriter")){ //내용+작성자 검색
            //where 1=1 (text like ~~ or writer like ~~)
        ...
        //memoRepository.findAll(불린빌더, 페이지객체)
