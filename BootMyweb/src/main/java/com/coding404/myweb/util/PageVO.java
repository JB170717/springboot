...
public class PageVO {
    ...
    public PageVO(Criteria cri, int total) {
        ...
        //페이지 끝번호 계산
        //현재 조회하는 페이지가 11번 -> 끝페이지번호 20
        //현재 조회하는 페이지가 5번 -> 끝페이지번호 10
        //(int)(Math.ceil(현재조회하는번호/ 페이지네이션개수))* 페이지네이션 ㄱ수
        ...
        //실제 끝번호 계산
        //데이터가 53개라면 -> 실제 마지막 페이지번호 6
        //데이터가 165개라면 -> 실제 마지막 페이지번호 17
        ...
        if(this.end > realEnd){
            this.end=realEnd; //11~20페이지 조회시, end=20, realEnd=17 이 경우
        }
